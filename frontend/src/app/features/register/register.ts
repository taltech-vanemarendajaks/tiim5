...
export class Register {
  ...
  readonly studyLevelOptions = [
    { label: 'Bachelor', value: CurriculumResponse.studyLevel.BACHELOR },
    { label: 'Master', value: CurriculumResponse.studyLevel.MASTER },
    { label: 'Integrated', value: CurriculumResponse.studyLevel.INTEGRATED },
    { label: 'Doctor', value: CurriculumResponse.studyLevel.DOCTOR },
  ];
